...
namespace ProjectVersion2
{
    public class Course  //comment stocker la classe course et ses etudiants a long terme
    {
        ...
        public Course(string _name)  //this constructor is used when it is the first time a course is created
        {
            this.name = _name;
        ...
        public void ViewDatas()
        {
            ...
            foreach(WorkGroup group in allGroups)
            {
                Console.WriteLine("group name :" + group.name + "professor : "+ group.professor.name + " " + group.professor.surname);
                foreach(Student student in group.members)
                {
